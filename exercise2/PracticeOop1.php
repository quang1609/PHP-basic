...
$object1->check1 = $object1->checkValidString($content1, 'book', 'restaurant');

//File2
$content2 = $object1->readFile('file2.txt');
$sentance = substr_count($content2, '.');
$object1->check2 = $object1->checkValidString($content2, 'book', 'restaurant');

//Check
$checkFile1 = $object1->check1 == true ? 'File1 là chuỗi "Hợp lệ"' : 'check1 là chuỗi "Không hợp lệ"';
$checkFile2 = $object1->check2 == true ? 'File2 là chuỗi "Hợp lệ".Chuỗi có '. $sentance . ' câu' : 'File2 là chuỗi "Không hợp lệ"';

//Result
$str =" $checkFile1 \n $checkFile2 ";
$object1->writeFile('result.txt', $str);